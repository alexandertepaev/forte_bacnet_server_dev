...
/*! @brief Concrete class representing BACnet Binary Value Object
 *
...
public:
  CBacnetBinaryValueObject(TForteUInt32 paObjectID, bool paPresentValue, bool paCOVReportingEnabled, CBacnetObjectConfigFB *paConfigFB);
