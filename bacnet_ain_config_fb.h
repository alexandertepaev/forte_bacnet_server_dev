 ...
 *   Alexander Tepaev
 *******************************************************************************/
#ifndef _BACnetAnalogInput_H_
#define _BACnetAnalogInput_H_
...
class CBACnetAnalogInputObject;

/*! @brief Analog Input BACnet object configuration FB
 * 
 * This class is a concrete class of the CBacnetObjectConfigFB and represents a Analog Input 
 * BACnet object configuration FB.
 * Creates an instance of CBacnetAnalogInputObject, sets its parameters and updates 
 ...
 */
class CBacnetAnalogInputConfigFB: public CBacnetObjectConfigFB{
  DECLARE_FIRMWARE_FB(CBacnetAnalogInputConfigFB)

public:
  CBacnetAnalogInputConfigFB(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes);
  ~CBacnetAnalogInputConfigFB();

protected:
  /*! @brief Initializes BACnet Analog Input object
   *
   * This method is responsible for the initialization of the a BACnet Analog Value.
   * In particular, it creates an instance of CBacnetAnalogInputObject object, pushes it into the server controller's 
   ...
   */
  const char * init();
  CBACnetAnalogInputObject *mObject; //!< Pointer to the CBacnetAnalogInputObject created in init method
...
private:
   ...
   *
   * This method represents execution entry point of BACnet Analog Input Object configuration FB.
