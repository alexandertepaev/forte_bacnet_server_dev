...
/*! @brief Analog Output BACnet object configuration FB
 * 
 * This class is a concrete class of the CBacnetObjectConfigFB and represents a Analog Output 
 * BACnet object configuration FB.
 * Creates an instance of CBacnetAnalogOutputObject, sets its parameters and updates 
 ...
 */
class CBacnetAnalogOutputConfigFB: public CBacnetObjectConfigFB{
  DECLARE_FIRMWARE_FB(CBacnetAnalogOutputConfigFB)

public:
  CBacnetAnalogOutputConfigFB(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes);
  ~CBacnetAnalogOutputConfigFB();

protected:
  /*! @brief Initializes BACnet Analog Output object
   *
   * This method is responsible for the initialization of the a BACnet Analog Value.
   * In particular, it creates an instance of CBacnetAnalogOutputObject object, pushes it into the server controller's 
   ...
   */
  const char * init();
  CBacnetAnalogOutputObject *mObject; //!< Pointer to the CBacnetAnalogOutputObject created in init method
...
private:
   ...
   *
   * This method represents execution entry point of BACnet Analog Output Object configuration FB.
