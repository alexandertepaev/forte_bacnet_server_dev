...
class CBacnetBinaryOutputObject;

/*! @brief Binary Output BACnet object configuration FB
 * 
 * This class is a concrete class of the CBacnetObjectConfigFB and represents a Binary Output 
 * BACnet object configuration FB.
 * Creates an instance of CBacnetBinaryOutputObject, sets its parameters and updates 
 ...
 * 
 */
class CBacnetBinaryOutputConfigFB: public CBacnetObjectConfigFB{
  DECLARE_FIRMWARE_FB(CBacnetBinaryOutputConfigFB)


public:
  CBacnetBinaryOutputConfigFB(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes);
  ~CBacnetBinaryOutputConfigFB();

protected:
  /*! @brief Initializes BACnet Binary Output object
   *
   * This method is responsible for the initialization of the a BACnet Binary Output.
   * In particular, it creates an instance of CBacnetBinaryOutputObject object, pushes it into the server controller's 
   ...
   */
  const char * init();
  CBacnetBinaryOutputObject *mObject; //!< Pointer to the CBacnetBinaryOutputObject created in init method
...
private:
   ...
   *
   * This method represents execution entry point of BACnet Binary Output Object configuration FB.
